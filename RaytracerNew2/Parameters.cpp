...
CREATE_PARAM_FUNC(real, real, Real)
...
CREATE_PARAM_FUNC(BSSRDF::ptr, BSSRDF::ptr, BSSRDF)
CREATE_PARAM_FUNC(Light::ptr, Light::ptr, Light)
CREATE_PARAM_FUNC(Texture::ptr, Texture::ptr, Texture)
CREATE_PARAM_FUNC(Medium::ptr, Medium::ptr, Medium)
CREATE_PARAM_FUNC(PhaseFunction::ptr, PhaseFunction::ptr, PhaseFunction)
CREATE_PARAM_FUNC(Volume::ptr, Volume::ptr, Volume)
