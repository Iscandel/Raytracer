...
Color PathTracingMIS::li(Scene & scene, Sampler::ptr sampler, const Ray & ray)
{
...
Color PathTracingMIS::li(Scene & scene, Sampler::ptr sampler, const Ray & ray, int depth, const Intersection& inter, Color& throughput, double& eta)
{
	Color radiance;
